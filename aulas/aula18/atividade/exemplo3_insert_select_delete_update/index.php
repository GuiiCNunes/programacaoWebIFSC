...
<html lang="en" dir="ltr">
  ...
  <body>
    <form class="" action="funcoes.inc.php?funcao=cadastrar" method="post">
      ...
      <input type="submit" name="btn_visualizar" value="Ver Dados" onclick="location.href='visualizar.php'">
    </form>
  </body>
</html>
